...
{
  builtin_interfaces__msg__Duration__Array * array = (builtin_interfaces__msg__Duration__Array *)malloc(sizeof(builtin_interfaces__msg__Duration__Array));
  if (!array) {
    return NULL;
  }
  bool success = builtin_interfaces__msg__Duration__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    builtin_interfaces__msg__Duration__Array__fini(array);
  }
  free(array);
}
