...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Primitives_service_members = {
  ...
  // see get_service_type_support_handle<test_msgs::Primitives>()
...
get_service_type_support_handle<test_msgs::srv::Primitives>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::test_msgs::srv::rosidl_typesupport_introspection_cpp::Primitives_service_type_support_handle;
    ...
    service_members->response_members_ == nullptr)
  {
    ...
    service_members->request_members_ = static_cast<
      ...
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::test_msgs::srv::Primitives_Request
      >()->data
      );
    ...
    service_members->response_members_ = static_cast<
      ...
      >(
      ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<
        ::test_msgs::srv::Primitives_Response
      >()->data
      );
  }
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, test_msgs, Primitives)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<test_msgs::srv::Primitives>();
}
