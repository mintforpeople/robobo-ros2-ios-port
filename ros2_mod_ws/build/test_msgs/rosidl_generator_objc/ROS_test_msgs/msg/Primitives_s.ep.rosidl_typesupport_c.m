...
@interface ROS_test_msgs_msg_Primitives ()
@end

@implementation ROS_test_msgs_msg_Primitives
...
ROS_test_msgs_msg_Primitives_convert_from_objc(
    ROS_test_msgs_msg_Primitives* _message_objc) {
  // NOTE(esteve): avoid unused parameter warning
  (void)_message_objc;

  test_msgs__msg__Primitives* ros_message =
...
ROS_test_msgs_msg_Primitives*
ROS_test_msgs_msg_Primitives_convert_to_objc(
    test_msgs__msg__Primitives* ros_message) {
  // NOTE(esteve): avoid unused parameter warning
  (void)ros_message;

  ROS_test_msgs_msg_Primitives* message =
      [[ROS_test_msgs_msg_Primitives alloc] init];
...
+ (intptr_t)destroyMsgPtr {
   intptr_t ptr =
       (intptr_t)test_msgs__msg__Primitives__destroy;
   return ptr;
 }

+ (intptr_t)fromObjcConverterPtr {
  intptr_t ptr =
      (intptr_t)ROS_test_msgs_msg_Primitives_convert_from_objc;
  return ptr;
}
...
+ (test_msgs__msg__Primitives*)fromObjc:(ROS_test_msgs_msg_Primitives*) message_objc_ {
  return ROS_test_msgs_msg_Primitives_convert_from_objc(message_objc_);
}

+ (ROS_test_msgs_msg_Primitives*)toObjc:(test_msgs__msg__Primitives*) message_c_ {
  return ROS_test_msgs_msg_Primitives_convert_to_objc(message_c_);
}
