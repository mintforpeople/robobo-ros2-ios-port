...
{
  test_msgs__msg__Builtins__Array * array = (test_msgs__msg__Builtins__Array *)malloc(sizeof(test_msgs__msg__Builtins__Array));
  if (!array) {
    return NULL;
  }
  bool success = test_msgs__msg__Builtins__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    test_msgs__msg__Builtins__Array__fini(array);
  }
  free(array);
}
