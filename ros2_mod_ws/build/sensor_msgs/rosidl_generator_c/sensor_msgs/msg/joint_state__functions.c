...
sensor_msgs__msg__JointState__init(sensor_msgs__msg__JointState * msg)
{
  ...
  // name
  if (!rosidl_generator_c__String__Array__init(&msg->name, 0)) {
    sensor_msgs__msg__JointState__destroy(msg);
    return false;
  }
  // position
  if (!rosidl_generator_c__float64__Array__init(&msg->position, 0)) {
    sensor_msgs__msg__JointState__destroy(msg);
    return false;
  }
  // velocity
  if (!rosidl_generator_c__float64__Array__init(&msg->velocity, 0)) {
    sensor_msgs__msg__JointState__destroy(msg);
    return false;
  }
  // effort
