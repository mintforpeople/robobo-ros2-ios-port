...
rcl_interfaces__msg__ParameterEventDescriptors__init(rcl_interfaces__msg__ParameterEventDescriptors * msg)
{
  ...
  // new_parameters
  if (!rcl_interfaces__msg__ParameterDescriptor__Array__init(&msg->new_parameters, 0)) {
    rcl_interfaces__msg__ParameterEventDescriptors__destroy(msg);
    return false;
  }
  // changed_parameters
  if (!rcl_interfaces__msg__ParameterDescriptor__Array__init(&msg->changed_parameters, 0)) {
    rcl_interfaces__msg__ParameterEventDescriptors__destroy(msg);
    return false;
  }
  // deleted_parameters
  if (!rcl_interfaces__msg__ParameterDescriptor__Array__init(&msg->deleted_parameters, 0)) {
    rcl_interfaces__msg__ParameterEventDescriptors__destroy(msg);
    return false;
  }
  return true;
