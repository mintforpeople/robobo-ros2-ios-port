...
{
  geometry_msgs__msg__Vector3__Array * array = (geometry_msgs__msg__Vector3__Array *)malloc(sizeof(geometry_msgs__msg__Vector3__Array));
  if (!array) {
    return NULL;
  }
  bool success = geometry_msgs__msg__Vector3__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    geometry_msgs__msg__Vector3__Array__fini(array);
  }
  free(array);
}
