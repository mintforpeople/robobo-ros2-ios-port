...
#include "robobo_msgs/msg/set_emotion_topic__struct.hpp"
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetEmotionTopic_message_member_array[1] = {
  {
    ...
    offsetof(robobo_msgs::msg::SetEmotionTopic, emotion),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetEmotionTopic_message_members = {
  ...
  1,  // number of fields
  sizeof(robobo_msgs::msg::SetEmotionTopic),
...
get_message_type_support_handle<robobo_msgs::msg::SetEmotionTopic>()
{
  return &::robobo_msgs::msg::rosidl_typesupport_introspection_cpp::SetEmotionTopic_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robobo_msgs, msg, SetEmotionTopic)() {
  return &::robobo_msgs::msg::rosidl_typesupport_introspection_cpp::SetEmotionTopic_message_type_support_handle;
}
