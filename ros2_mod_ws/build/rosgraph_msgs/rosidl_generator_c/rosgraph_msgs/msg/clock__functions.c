...
{
  rosgraph_msgs__msg__Clock__Array * array = (rosgraph_msgs__msg__Clock__Array *)malloc(sizeof(rosgraph_msgs__msg__Clock__Array));
  if (!array) {
    return NULL;
  }
  bool success = rosgraph_msgs__msg__Clock__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    rosgraph_msgs__msg__Clock__Array__fini(array);
  }
  free(array);
}
