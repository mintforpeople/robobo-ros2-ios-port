...
#ifndef ROBOBO_MSGS_AUX__SRV__PLAY_SOUND_H_
#define ROBOBO_MSGS_AUX__SRV__PLAY_SOUND_H_
...
const rosidl_service_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, robobo_msgs_aux, PlaySound)();

#if defined(__cplusplus)
}
#endif

#endif  // ROBOBO_MSGS_AUX__SRV__PLAY_SOUND_H_
