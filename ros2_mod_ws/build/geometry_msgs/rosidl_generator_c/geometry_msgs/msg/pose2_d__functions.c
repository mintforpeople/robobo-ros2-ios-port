...
{
  geometry_msgs__msg__Pose2D__Array * array = (geometry_msgs__msg__Pose2D__Array *)malloc(sizeof(geometry_msgs__msg__Pose2D__Array));
  if (!array) {
    return NULL;
  }
  bool success = geometry_msgs__msg__Pose2D__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    geometry_msgs__msg__Pose2D__Array__fini(array);
  }
  free(array);
}
