...
#import "ROS_std_msgs/msg/Float64MultiArray.h"

@interface ROS_std_msgs_msg_Float64MultiArray ()
@end

@implementation ROS_std_msgs_msg_Float64MultiArray
...
ROS_std_msgs_msg_Float64MultiArray_convert_from_objc(
    ROS_std_msgs_msg_Float64MultiArray* _message_objc) {
...
// TODO(fmrico): Implemening array
  rosidl_generator_c__float64__Array__init(&ros_message->data, [[_message_objc data] count]);
  for (unsigned long i=0; i<[[_message_objc data] count]; i++)
    ros_message->data.data[i] =
    (double)[[_message_objc data][i] doubleValue];
    //[[_message_objc.data[i]);
  return ros_message;
}

ROS_std_msgs_msg_Float64MultiArray*
ROS_std_msgs_msg_Float64MultiArray_convert_to_objc(
    std_msgs__msg__Float64MultiArray* ros_message) {
  // NOTE(esteve): avoid unused parameter warning
  (void)ros_message;

  ROS_std_msgs_msg_Float64MultiArray* message =
      [[ROS_std_msgs_msg_Float64MultiArray alloc] init];
...
+ (intptr_t)destroyMsgPtr {
   intptr_t ptr =
       (intptr_t)std_msgs__msg__Float64MultiArray__destroy;
   return ptr;
 }

+ (intptr_t)fromObjcConverterPtr {
  intptr_t ptr =
      (intptr_t)ROS_std_msgs_msg_Float64MultiArray_convert_from_objc;
  return ptr;
}
...
+ (std_msgs__msg__Float64MultiArray*)fromObjc:(ROS_std_msgs_msg_Float64MultiArray*) message_objc_ {
  return ROS_std_msgs_msg_Float64MultiArray_convert_from_objc(message_objc_);
}

+ (ROS_std_msgs_msg_Float64MultiArray*)toObjc:(std_msgs__msg__Float64MultiArray*) message_c_ {
  return ROS_std_msgs_msg_Float64MultiArray_convert_to_objc(message_c_);
}
