...
{
  std_srvs__srv__SetBool_Request__Array * array = (std_srvs__srv__SetBool_Request__Array *)malloc(sizeof(std_srvs__srv__SetBool_Request__Array));
  if (!array) {
    return NULL;
  }
  bool success = std_srvs__srv__SetBool_Request__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    std_srvs__srv__SetBool_Request__Array__fini(array);
  }
  free(array);
}
