...
#import "ROS_test_msgs/msg/DynamicArrayPrimitives.h"

@interface ROS_test_msgs_msg_DynamicArrayPrimitives ()
@end

@implementation ROS_test_msgs_msg_DynamicArrayPrimitives
...
ROS_test_msgs_msg_DynamicArrayPrimitives_convert_from_objc(
    ROS_test_msgs_msg_DynamicArrayPrimitives* _message_objc) {
  // NOTE(esteve): avoid unused parameter warning
  (void)_message_objc;

  test_msgs__msg__DynamicArrayPrimitives* ros_message =
...
ROS_test_msgs_msg_DynamicArrayPrimitives*
ROS_test_msgs_msg_DynamicArrayPrimitives_convert_to_objc(
    test_msgs__msg__DynamicArrayPrimitives* ros_message) {
  // NOTE(esteve): avoid unused parameter warning
  (void)ros_message;

  ROS_test_msgs_msg_DynamicArrayPrimitives* message =
      [[ROS_test_msgs_msg_DynamicArrayPrimitives alloc] init];
...
+ (intptr_t)destroyMsgPtr {
   intptr_t ptr =
       (intptr_t)test_msgs__msg__DynamicArrayPrimitives__destroy;
   return ptr;
 }

+ (intptr_t)fromObjcConverterPtr {
  intptr_t ptr =
      (intptr_t)ROS_test_msgs_msg_DynamicArrayPrimitives_convert_from_objc;
  return ptr;
}
...
+ (test_msgs__msg__DynamicArrayPrimitives*)fromObjc:(ROS_test_msgs_msg_DynamicArrayPrimitives*) message_objc_ {
  return ROS_test_msgs_msg_DynamicArrayPrimitives_convert_from_objc(message_objc_);
}

+ (ROS_test_msgs_msg_DynamicArrayPrimitives*)toObjc:(test_msgs__msg__DynamicArrayPrimitives*) message_c_ {
  return ROS_test_msgs_msg_DynamicArrayPrimitives_convert_to_objc(message_c_);
}
