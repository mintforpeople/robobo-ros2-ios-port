...
{
  const std::vector<test_msgs::msg::Primitives> * member =
    reinterpret_cast<const std::vector<test_msgs::msg::Primitives> *>(untyped_member);
  return member->size();
}
...
{
  std::vector<test_msgs::msg::Primitives> & member =
    *reinterpret_cast<std::vector<test_msgs::msg::Primitives> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundedArrayNested_message_member_array[1] = {
  {
    ...
    4,  // array size
    true,  // is upper bound
    offsetof(test_msgs::msg::BoundedArrayNested, primitive_values),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundedArrayNested_message_members = {
  ...
  1,  // number of fields
  sizeof(test_msgs::msg::BoundedArrayNested),
...
get_message_type_support_handle<test_msgs::msg::BoundedArrayNested>()
{
  return &::test_msgs::msg::rosidl_typesupport_introspection_cpp::BoundedArrayNested_message_type_support_handle;
}
