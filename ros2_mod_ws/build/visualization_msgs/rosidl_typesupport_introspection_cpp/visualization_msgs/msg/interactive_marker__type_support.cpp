...
{
  const std::vector<visualization_msgs::msg::MenuEntry> * member =
...
{
  std::vector<visualization_msgs::msg::MenuEntry> & member =
...
{
  const std::vector<visualization_msgs::msg::InteractiveMarkerControl> * member =
...
{
  std::vector<visualization_msgs::msg::InteractiveMarkerControl> & member =
