...
@interface ROS_lifecycle_msgs_srv_ChangeState_Request ()
@end

@implementation ROS_lifecycle_msgs_srv_ChangeState_Request
...
ROS_lifecycle_msgs_srv_ChangeState_Request_convert_from_objc(
    ROS_lifecycle_msgs_srv_ChangeState_Request* _message_objc) {
...
ROS_lifecycle_msgs_srv_ChangeState_Request*
ROS_lifecycle_msgs_srv_ChangeState_Request_convert_to_objc(
    lifecycle_msgs__srv__ChangeState_Request* ros_message) {
  // NOTE(esteve): avoid unused parameter warning
  (void)ros_message;

  ROS_lifecycle_msgs_srv_ChangeState_Request* message =
      [[ROS_lifecycle_msgs_srv_ChangeState_Request alloc] init];

  message.node_name = [NSString stringWithUTF8String:ros_message->node_name.data];
  message.transition = [ROS_lifecycle_msgs_msg_Transition toObjc:&ros_message->transition];
  return message;
}

+ (intptr_t)destroyMsgPtr {
   intptr_t ptr =
       (intptr_t)lifecycle_msgs__srv__ChangeState_Request__destroy;
   return ptr;
 }

+ (intptr_t)fromObjcConverterPtr {
  intptr_t ptr =
      (intptr_t)ROS_lifecycle_msgs_srv_ChangeState_Request_convert_from_objc;
  return ptr;
}
...
+ (lifecycle_msgs__srv__ChangeState_Request*)fromObjc:(ROS_lifecycle_msgs_srv_ChangeState_Request*) message_objc_ {
  return ROS_lifecycle_msgs_srv_ChangeState_Request_convert_from_objc(message_objc_);
}

+ (ROS_lifecycle_msgs_srv_ChangeState_Request*)toObjc:(lifecycle_msgs__srv__ChangeState_Request*) message_c_ {
  return ROS_lifecycle_msgs_srv_ChangeState_Request_convert_to_objc(message_c_);
}
