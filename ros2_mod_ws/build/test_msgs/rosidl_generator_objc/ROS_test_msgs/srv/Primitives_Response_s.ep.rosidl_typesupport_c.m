...
@interface ROS_test_msgs_srv_Primitives_Response ()
@end

@implementation ROS_test_msgs_srv_Primitives_Response
...
ROS_test_msgs_srv_Primitives_Response_convert_from_objc(
    ROS_test_msgs_srv_Primitives_Response* _message_objc) {
  // NOTE(esteve): avoid unused parameter warning
  (void)_message_objc;

  test_msgs__srv__Primitives_Response* ros_message =
...
ROS_test_msgs_srv_Primitives_Response*
ROS_test_msgs_srv_Primitives_Response_convert_to_objc(
    test_msgs__srv__Primitives_Response* ros_message) {
  // NOTE(esteve): avoid unused parameter warning
  (void)ros_message;

  ROS_test_msgs_srv_Primitives_Response* message =
      [[ROS_test_msgs_srv_Primitives_Response alloc] init];
...
+ (intptr_t)destroyMsgPtr {
   intptr_t ptr =
       (intptr_t)test_msgs__srv__Primitives_Response__destroy;
   return ptr;
 }

+ (intptr_t)fromObjcConverterPtr {
  intptr_t ptr =
      (intptr_t)ROS_test_msgs_srv_Primitives_Response_convert_from_objc;
  return ptr;
}
...
+ (test_msgs__srv__Primitives_Response*)fromObjc:(ROS_test_msgs_srv_Primitives_Response*) message_objc_ {
  return ROS_test_msgs_srv_Primitives_Response_convert_from_objc(message_objc_);
}

+ (ROS_test_msgs_srv_Primitives_Response*)toObjc:(test_msgs__srv__Primitives_Response*) message_c_ {
  return ROS_test_msgs_srv_Primitives_Response_convert_to_objc(message_c_);
}
