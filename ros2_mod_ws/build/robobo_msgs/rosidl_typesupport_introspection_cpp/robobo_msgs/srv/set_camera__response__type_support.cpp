...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SetCamera_Response_message_member_array[1] = {
  {
    ...
    offsetof(robobo_msgs::srv::SetCamera_Response, error),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SetCamera_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(robobo_msgs::srv::SetCamera_Response),
...
get_message_type_support_handle<robobo_msgs::srv::SetCamera_Response>()
{
  return &::robobo_msgs::srv::rosidl_typesupport_introspection_cpp::SetCamera_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robobo_msgs, srv, SetCamera_Response)() {
  return &::robobo_msgs::srv::rosidl_typesupport_introspection_cpp::SetCamera_Response_message_type_support_handle;
}
