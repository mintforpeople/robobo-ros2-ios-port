...
@interface ROS_robobo_msgs_aux_msg_IRs ()
@end

@implementation ROS_robobo_msgs_aux_msg_IRs
...
ROS_robobo_msgs_aux_msg_IRs_convert_from_objc(
    ROS_robobo_msgs_aux_msg_IRs* _message_objc) {
  // NOTE(esteve): avoid unused parameter warning
  (void)_message_objc;

  robobo_msgs_aux__msg__IRs* ros_message =
...
ROS_robobo_msgs_aux_msg_IRs*
ROS_robobo_msgs_aux_msg_IRs_convert_to_objc(
    robobo_msgs_aux__msg__IRs* ros_message) {
  // NOTE(esteve): avoid unused parameter warning
  (void)ros_message;

  ROS_robobo_msgs_aux_msg_IRs* message =
      [[ROS_robobo_msgs_aux_msg_IRs alloc] init];
...
+ (intptr_t)destroyMsgPtr {
   intptr_t ptr =
       (intptr_t)robobo_msgs_aux__msg__IRs__destroy;
   return ptr;
 }

+ (intptr_t)fromObjcConverterPtr {
  intptr_t ptr =
      (intptr_t)ROS_robobo_msgs_aux_msg_IRs_convert_from_objc;
  return ptr;
}
...
+ (robobo_msgs_aux__msg__IRs*)fromObjc:(ROS_robobo_msgs_aux_msg_IRs*) message_objc_ {
  return ROS_robobo_msgs_aux_msg_IRs_convert_from_objc(message_objc_);
}

+ (ROS_robobo_msgs_aux_msg_IRs*)toObjc:(robobo_msgs_aux__msg__IRs*) message_c_ {
  return ROS_robobo_msgs_aux_msg_IRs_convert_to_objc(message_c_);
}
