...
#import "ROS_std_msgs/msg/Int8MultiArray.h"

@interface ROS_std_msgs_msg_Int8MultiArray ()
@end

@implementation ROS_std_msgs_msg_Int8MultiArray
...
ROS_std_msgs_msg_Int8MultiArray_convert_from_objc(
    ROS_std_msgs_msg_Int8MultiArray* _message_objc) {
...
ROS_std_msgs_msg_Int8MultiArray*
ROS_std_msgs_msg_Int8MultiArray_convert_to_objc(
    std_msgs__msg__Int8MultiArray* ros_message) {
  // NOTE(esteve): avoid unused parameter warning
  (void)ros_message;

  ROS_std_msgs_msg_Int8MultiArray* message =
      [[ROS_std_msgs_msg_Int8MultiArray alloc] init];
...
+ (intptr_t)destroyMsgPtr {
   intptr_t ptr =
       (intptr_t)std_msgs__msg__Int8MultiArray__destroy;
   return ptr;
 }

+ (intptr_t)fromObjcConverterPtr {
  intptr_t ptr =
      (intptr_t)ROS_std_msgs_msg_Int8MultiArray_convert_from_objc;
  return ptr;
}
...
+ (std_msgs__msg__Int8MultiArray*)fromObjc:(ROS_std_msgs_msg_Int8MultiArray*) message_objc_ {
  return ROS_std_msgs_msg_Int8MultiArray_convert_from_objc(message_objc_);
}

+ (ROS_std_msgs_msg_Int8MultiArray*)toObjc:(std_msgs__msg__Int8MultiArray*) message_c_ {
  return ROS_std_msgs_msg_Int8MultiArray_convert_to_objc(message_c_);
}
