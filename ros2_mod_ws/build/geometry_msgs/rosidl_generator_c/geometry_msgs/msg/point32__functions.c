...
{
  geometry_msgs__msg__Point32__Array * array = (geometry_msgs__msg__Point32__Array *)malloc(sizeof(geometry_msgs__msg__Point32__Array));
  if (!array) {
    return NULL;
  }
  bool success = geometry_msgs__msg__Point32__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    geometry_msgs__msg__Point32__Array__fini(array);
  }
  free(array);
}
