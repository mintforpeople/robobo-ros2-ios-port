...
{
  geometry_msgs__msg__Point__Array * array = (geometry_msgs__msg__Point__Array *)malloc(sizeof(geometry_msgs__msg__Point__Array));
  if (!array) {
    return NULL;
  }
  bool success = geometry_msgs__msg__Point__Array__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
{
  if (array) {
    geometry_msgs__msg__Point__Array__fini(array);
  }
  free(array);
}
