...
#include "robobo_msgs/msg/play_sound_topic__struct.hpp"
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PlaySoundTopic_message_member_array[1] = {
  {
    ...
    offsetof(robobo_msgs::msg::PlaySoundTopic, sound),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PlaySoundTopic_message_members = {
  ...
  1,  // number of fields
  sizeof(robobo_msgs::msg::PlaySoundTopic),
...
get_message_type_support_handle<robobo_msgs::msg::PlaySoundTopic>()
{
  return &::robobo_msgs::msg::rosidl_typesupport_introspection_cpp::PlaySoundTopic_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, robobo_msgs, msg, PlaySoundTopic)() {
  return &::robobo_msgs::msg::rosidl_typesupport_introspection_cpp::PlaySoundTopic_message_type_support_handle;
}
